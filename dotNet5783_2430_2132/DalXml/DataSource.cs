...
internal class DataSource
{
    ...
    internal static class Config
    {
        ...
        {
            LoadData();
            XElement OrderId = configXml.Element("Config")!.Element("IdOrder")!;
        ...
        {
            LoadData();
            XElement OrderItemId = configXml.Element("Config")!.Element("IdOrderItem")!;
